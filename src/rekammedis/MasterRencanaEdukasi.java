 ...
 * @author dosen
 */
public class MasterRencanaEdukasi extends javax.swing.JDialog {
    ...
    private MasterKebutuhanEdukasi kebutuhan=new MasterKebutuhanEdukasi(null,false);

    /** Creates new form DlgSpesialis
     * @param parent
     * @param modal */
    public MasterRencanaEdukasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();


        Object[] row={"Kode Kebutuhan","Kebutuhan Edukasi/Komunikasi","Kode","Rencana Edukasi/Komunikasi"};
        ...
        kebutuhan.addWindowListener(new WindowListener() {
            @Override
            ...
            public void windowClosed(WindowEvent e) {
                if(kebutuhan.getTable().getSelectedRow()!= -1){
                    kdmasalah.setText(kebutuhan.getTable().getValueAt(kebutuhan.getTable().getSelectedRow(),0).toString());
                    nmmasalah.setText(kebutuhan.getTable().getValueAt(kebutuhan.getTable().getSelectedRow(),1).toString());
                }  
        ...
        kebutuhan.getTable().addKeyListener(new KeyListener() {
            @Override
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Rencana Edukasi :");
        ...
        namarencana.setBounds(265, 40, 240, 23);
        ...
        nmmasalah.setBounds(138, 10, 250, 23);
        ...
        btnPemeriksaan.setBounds(390, 10, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(kdrencana.getText().trim().equals("")){
            ...
            Sequel.menyimpan("master_rencana_edukasi_komunikasi","'"+kdmasalah.getText()+"','"+kdrencana.getText()+"','"+namarencana.getText()+"'","Kode");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,kdrencana,"master_rencana_edukasi_komunikasi","kd_rencana_edukasi")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(kdrencana.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                Sequel.mengedit("master_rencana_edukasi_komunikasi","kd_rencana_edukasi=?","kd_rencana_edukasi=?,rencana_edukasi=?,kode_kebutuhan_edukasi=?",4,new String[]{
    ...
    private void btnPemeriksaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPemeriksaanActionPerformed
        kebutuhan.isCek();
        kebutuhan.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        kebutuhan.setLocationRelativeTo(internalFrame1);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterRencanaEdukasi dialog = new MasterRencanaEdukasi(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select master_kebutuhan_edukasi_komunikasi.kd_kebutuhan_edukasi,master_kebutuhan_edukasi_komunikasi.kebutuhan_edukasi,"+
                    "master_rencana_edukasi_komunikasi.kd_rencana_edukasi,master_rencana_edukasi_komunikasi.rencana_edukasi from master_rencana_edukasi_komunikasi "+
                    "inner join master_kebutuhan_edukasi_komunikasi on master_kebutuhan_edukasi_komunikasi.kd_kebutuhan_edukasi=master_rencana_edukasi_komunikasi.kode_kebutuhan_edukasi "+
                    "where master_rencana_edukasi_komunikasi.kd_rencana_edukasi like ? or master_rencana_edukasi_komunikasi.rencana_edukasi like ? or "+
                    "master_kebutuhan_edukasi_komunikasi.kebutuhan_edukasi like ? order by master_kebutuhan_edukasi_komunikasi.kebutuhan_edukasi");
            try {
