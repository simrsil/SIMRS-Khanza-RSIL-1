 ...
 * @author dosen
 */
public class MasterKebutuhanEdukasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterKebutuhanEdukasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();


        Object[] row={"Kode","Kebutuhan Edukasi"};
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Kebutuhan Edukasi/Komunikasi :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass7.add(jLabel4);
        jLabel4.setBounds(122, 10, 160, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("master_kebutuhan_edukasi_komunikasi","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode")==true){
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,TKd,"master_kebutuhan_edukasi_komunikasi","kd_kebutuhan_edukasi")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()> -1){
                if(Sequel.mengedittf("master_kebutuhan_edukasi_komunikasi","kd_kebutuhan_edukasi=?","kd_kebutuhan_edukasi=?,kebutuhan_edukasi=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterKebutuhanEdukasi dialog = new MasterKebutuhanEdukasi(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from master_kebutuhan_edukasi_komunikasi where master_kebutuhan_edukasi_komunikasi.kd_kebutuhan_edukasi like ? or master_kebutuhan_edukasi_komunikasi.kebutuhan_edukasi like ? order by master_kebutuhan_edukasi_komunikasi.kd_kebutuhan_edukasi");
            try {
