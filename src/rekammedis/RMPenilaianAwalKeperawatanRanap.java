...
public final class RMPenilaianAwalKeperawatanRanap extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalKeperawatanRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "m. Edukasi Diberikan Kepada", "Kemampuan Baca Tulis", "Butuh Penerjemah", "Ket Butuh Penerjemah", "Terdapat Hambatan Belajar", "Hambatan Belajar", "Ket Hambatan Belajar",
            ...
            "Motivasi", "Nyeri", "Penyebab Nyeri", "Kualitas Nyeri", "Lokasi Nyeri", "Nyeri Menyebar", "Skala Nyeri", "Waktu / Durasi", "Nyeri Hilang Bila",
            ...
            "Informasi Perencanaan Pulang", "Lama Rata-Rata", "Tanggal Pulang", "Kondisi Saat Pulang", "Perawatan Lanjutan", "Cara Transportasi", "Transportasi Digunakan", "Rencana Keperawatan Lainnya"
        }) {
            @Override
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-04-2026 07:22:43" }));
        ...
        jSeparator8.setBounds(10, 2060, 880, 1);
        ...
        jLabel203.setBounds(20, 2060, 380, 23);
        ...
        jSeparator9.setBounds(370, 2080, 1, 140);
        ...
        PanelWall.setBounds(50, 2080, 320, 130);
        ...
        Provokes.setBounds(580, 2080, 130, 23);
        ...
        Quality.setBounds(440, 2110, 140, 23);
        ...
        jLabel210.setBounds(430, 2190, 60, 23);
        ...
        Durasi.setBounds(730, 2190, 90, 23);
        ...
        jLabel212.setBounds(820, 2190, 35, 23);
        ...
        NyeriHilang.setBounds(140, 2220, 130, 23);
        ...
        KetNyeri.setBounds(270, 2220, 150, 23);
        ...
        KetPadaDokter.setBounds(780, 2220, 80, 23);
        ...
        jSeparator10.setBounds(0, 2270, 880, 1);
        ...
        SkalaResiko1.setBounds(430, 2310, 280, 23);

        jLabel218.setText("Nilai :");
        jLabel218.setName("jLabel218"); // NOI18N
        FormInput.add(jLabel218);
        jLabel218.setBounds(720, 2310, 75, 23);
        ...
        SkalaResiko2.setBounds(430, 2340, 280, 23);

        jLabel222.setText("Nilai :");
        jLabel222.setName("jLabel222"); // NOI18N
        FormInput.add(jLabel222);
        jLabel222.setBounds(720, 2340, 75, 23);
        ...
        SkalaResiko3.setBounds(430, 2370, 280, 23);

        jLabel225.setText("Nilai :");
        jLabel225.setName("jLabel225"); // NOI18N
        FormInput.add(jLabel225);
        jLabel225.setBounds(720, 2370, 75, 23);
        ...
        SkalaResiko4.setBounds(430, 2400, 280, 23);

        jLabel228.setText("Nilai :");
        jLabel228.setName("jLabel228"); // NOI18N
        FormInput.add(jLabel228);
        jLabel228.setBounds(720, 2400, 75, 23);
        ...
        NilaiResiko5.setBounds(800, 2430, 60, 23);
        ...
        NilaiResiko6.setBounds(800, 2460, 60, 23);

        jLabel235.setText("Total :");
        jLabel235.setName("jLabel235"); // NOI18N
        FormInput.add(jLabel235);
        jLabel235.setBounds(720, 2490, 75, 23);
        ...
        NilaiResikoTotal.setBounds(800, 2490, 60, 23);
        ...
        TingkatResiko.setBounds(70, 2490, 640, 23);

        jLabel58.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel58.setText("Skala Sydney :");
        jLabel58.setName("jLabel58"); // NOI18N
        FormInput.add(jLabel58);
        jLabel58.setBounds(50, 2520, 80, 23);
        ...
        NilaiSydney1.setBounds(800, 2540, 60, 23);
        ...
        NilaiSydney2.setBounds(800, 2570, 60, 23);
        ...
        NilaiSydney3.setBounds(800, 2600, 60, 23);
        ...
        NilaiSydney4.setBounds(800, 2630, 60, 23);
        ...
        NilaiSydney5.setBounds(800, 2660, 60, 23);
        ...
        NilaiSydney6.setBounds(800, 2690, 60, 23);
        ...
        NilaiSydney7.setBounds(800, 2720, 60, 23);
        ...
        jLabel257.setBounds(80, 2740, 480, 23);
        ...
        NilaiSydney8.setBounds(800, 2770, 60, 23);
        ...
        NilaiSydney9.setBounds(800, 2800, 60, 23);
        ...
        NilaiSydney10.setBounds(800, 2830, 60, 23);
        ...
        NilaiSydney11.setBounds(800, 2860, 60, 23);
        ...
        TingkatSydney.setBounds(70, 2890, 650, 23);
        ...
        jSeparator11.setBounds(10, 2930, 880, 1);
        ...
        jLabel271.setBounds(20, 2930, 380, 23);
        ...
        jLabel272.setBounds(50, 2950, 380, 23);
        ...
        NilaiGizi1.setBounds(800, 2950, 60, 23);
        ...
        jLabel274.setBounds(50, 2980, 380, 23);
        ...
        NilaiGiziTotal.setBounds(800, 3010, 60, 23);
        ...
        DiagnosaKhususGizi.setBounds(220, 3040, 80, 23);
        ...
        jLabel277.setBounds(50, 3040, 206, 23);
        ...
        KeteranganDiketahuiDietisen.setBounds(800, 3040, 60, 23);
        ...
        jSeparator12.setBounds(10, 3260, 880, 1);
        ...
        Scroll6.setBounds(20, 3270, 400, 143);
        ...
        TabRencanaKeperawatan.setBounds(440, 3270, 420, 143);
        ...
        BtnTambahMasalah.setBounds(370, 3420, 28, 23);
        ...
        BtnAllMasalah.setBounds(340, 3420, 28, 23);
        ...
        BtnCariMasalah.setBounds(310, 3420, 28, 23);
        ...
        TCariMasalah.setBounds(90, 3420, 215, 23);
        ...
        BtnTambahRencana.setBounds(820, 3420, 28, 23);
        ...
        BtnAllRencana.setBounds(780, 3420, 28, 23);
        ...
        BtnCariRencana.setBounds(750, 3420, 28, 23);

        label13.setText("Key Word :");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label13);
        label13.setBounds(450, 3420, 60, 23);
        ...
        TCariRencana.setBounds(510, 3420, 235, 23);

        label12.setText("Key Word :");
        label12.setName("label12"); // NOI18N
        label12.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label12);
        label12.setBounds(30, 3420, 60, 23);
        ...
        jLabel289.setBounds(10, 2220, 130, 23);
        ...
        jLabel290.setBounds(10, 3040, 208, 23);
        ...
        jSeparator16.setBounds(10, 3070, 880, 1);

        jLabel291.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel291.setText("VIII. PERENCANAAN PULANG (DISCHARGE PLANNING)");
        jLabel291.setName("jLabel291"); // NOI18N
        FormInput.add(jLabel291);
        jLabel291.setBounds(30, 3070, 380, 23);
        ...
        TanggalPulang.setBounds(770, 3090, 90, 23);

        jLabel296.setText("Lama Rawat Rata-rata :");
        jLabel296.setName("jLabel296"); // NOI18N
        FormInput.add(jLabel296);
        jLabel296.setBounds(450, 3090, 130, 23);
        ...
        LamaRatarata.setBounds(580, 3090, 55, 23);

        jLabel297.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel297.setText("Perawatan Lanjutan Yang Diberikan Di Rumah");
        jLabel297.setName("jLabel297"); // NOI18N
        FormInput.add(jLabel297);
        jLabel297.setBounds(40, 3150, 240, 23);
        ...
        scrollPane10.setBounds(280, 3150, 576, 43);

        jLabel298.setText(":");
        jLabel298.setName("jLabel298"); // NOI18N
        FormInput.add(jLabel298);
        jLabel298.setBounds(10, 3150, 260, 20);
        ...
        CaraTransportasiPulang.setBounds(180, 3200, 160, 23);

        jLabel299.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel299.setText("Cara Transportasi Pulang");
        jLabel299.setName("jLabel299"); // NOI18N
        FormInput.add(jLabel299);
        jLabel299.setBounds(50, 3200, 140, 23);

        jLabel300.setText(":");
        jLabel300.setName("jLabel300"); // NOI18N
        FormInput.add(jLabel300);
        jLabel300.setBounds(10, 3200, 174, 23);

        jLabel301.setText("Transportasi Yang Digunakan :");
        jLabel301.setName("jLabel301"); // NOI18N
        FormInput.add(jLabel301);
        jLabel301.setBounds(350, 3200, 167, 23);
        ...
        TransportasiYangDigunakan.setBounds(520, 3200, 140, 23);

        jLabel302.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel302.setText("IV. ASESMEN KEBUTUHAN EDUKASI DAN KOMUNIKASI");
        jLabel302.setName("jLabel302"); // NOI18N
        FormInput.add(jLabel302);
        jLabel302.setBounds(10, 1820, 400, 23);
        ...
        jSeparator15.setBounds(10, 1810, 880, 1);
        ...
        BtnTambahKebutuhanEdukasi.setBounds(370, 2020, 28, 23);
        ...
        BtnAllKebutuhanEdukasi.setBounds(340, 2020, 28, 23);
        ...
        BtnCariKebutuhanEdukasi.setBounds(310, 2020, 28, 23);
        ...
        TabRencanaKeperawatan2.setBounds(440, 1850, 420, 150);
        ...
        TCariKebutuhanEdukasi.setBounds(90, 2020, 215, 23);
        ...
        BtnTambahRencanaEdukasi.setBounds(810, 2020, 28, 23);
        ...
        BtnAllRencanaEdukasi.setBounds(780, 2020, 28, 23);
        ...
        TCariRencanaEdukasi.setBounds(510, 2020, 235, 23);
        ...
        KeteranganButuhPenerjemah.setBounds(630, 1580, 240, 23);
        ...
        jLabel306.setBounds(370, 1610, 20, 23);

        jLabel307.setText(":");
        jLabel307.setName("jLabel307"); // NOI18N
        FormInput.add(jLabel307);
        jLabel307.setBounds(10, 1610, 252, 23);
        ...
        TerdapatHambatanBelajar.setBounds(270, 1610, 90, 23);

        jLabel308.setText("Jika Ya :");
        jLabel308.setName("jLabel308"); // NOI18N
        FormInput.add(jLabel308);
        jLabel308.setBounds(350, 1610, 60, 23);
        ...
        HambatanBelajar.setBounds(420, 1610, 177, 23);
        ...
        KeteranganHambatanBelajar.setBounds(600, 1610, 274, 23);
        ...
        jLabel309.setBounds(60, 1610, 240, 23);
        ...
        jLabel310.setBounds(610, 1580, 30, 23);

        jLabel311.setText(":");
        jLabel311.setName("jLabel311"); // NOI18N
        FormInput.add(jLabel311);
        jLabel311.setBounds(20, 1640, 160, 23);
        ...
        HambatanCaraBicara.setBounds(180, 1640, 150, 23);
        ...
        CaraBelajarDisukai.setBounds(740, 1640, 130, 23);
        ...
        jLabel314.setBounds(60, 1640, 140, 23);

        jLabel315.setText(":");
        jLabel315.setName("jLabel315"); // NOI18N
        FormInput.add(jLabel315);
        jLabel315.setBounds(20, 1670, 202, 23);
        ...
        KesediaanMenerimaInformasi.setBounds(220, 1670, 90, 23);
        ...
        KeteranganKesediaanMenerimaInformasi.setBounds(320, 1670, 273, 23);
        ...
        PemahamanNutrisi.setBounds(780, 1670, 90, 23);
        ...
        PemahamanPenyakit.setBounds(220, 1700, 90, 23);
        ...
        PemahamanPerawatan.setBounds(780, 1700, 90, 23);
        ...
        HambatanEmosional.setBounds(750, 1730, 90, 23);
        ...
        KeterbatasanFisik.setBounds(460, 1730, 150, 23);
        ...
        Motivasi.setBounds(190, 1760, 90, 23);
        ...
        jLabel325.setBounds(90, 1730, 100, 23);
        ...
        jLabel326.setBounds(10, 1560, 400, 23);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-04-2026" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-04-2026" }));
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            try {
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "penilaian_awal_keperawatan_ranap.riwayat_psiko_pendidikan_pj,penilaian_awal_keperawatan_ranap.riwayat_psiko_edukasi_diberikan,penilaian_awal_keperawatan_ranap.riwayat_psiko_edukasi_diberikan_keterangan,penilaian_awal_keperawatan_ranap.kemampuan_baca_tulis,penilaian_awal_keperawatan_ranap.butuh_penerjemah,penilaian_awal_keperawatan_ranap.keterangan_butuh_penerjemah,"
                        + "penilaian_awal_keperawatan_ranap.terdapat_hambatan_belajar,penilaian_awal_keperawatan_ranap.hambatan_belajar,penilaian_awal_keperawatan_ranap.keterangan_hambatan_belajar,penilaian_awal_keperawatan_ranap.hambatan_cara_bicara,"
                        + "penilaian_awal_keperawatan_ranap.hambatan_bahasa_isyarat,penilaian_awal_keperawatan_ranap.cara_belajar_disukai,penilaian_awal_keperawatan_ranap.kesediaan_menerima_informasi,penilaian_awal_keperawatan_ranap.ket_kesediaan_menerima_informasi,"
                        + "penilaian_awal_keperawatan_ranap.pemahaman_nutrisi,penilaian_awal_keperawatan_ranap.pemahaman_penyakit,penilaian_awal_keperawatan_ranap.pemahaman_pengobatan,penilaian_awal_keperawatan_ranap.pemahaman_perawatan,"
                        + "penilaian_awal_keperawatan_ranap.keyakinan_nilai,penilaian_awal_keperawatan_ranap.keterbatasan_fisik,penilaian_awal_keperawatan_ranap.hambatan_emosional,penilaian_awal_keperawatan_ranap.motivasi,"
                        ...
                        case "Laporan 1 (HTML)":
                            ...
                            htmlContent.append(
                                    "<tr class='isi'>").append(
                                            ...
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Kemampuan Baca Tulis</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Butuh Penerjemah</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Ket.Butuh Penerjemah</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Terdapat Hambatan Belajar</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Hambatan Belajar</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Ket. Hambatan Belajar</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Hambatan Cara Bicara</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Hambatan Bahasa Isyarat</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Cara Belajar Disukai</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Kesediaan Menerima Informasi</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Ket. Kesediaan Menerima Informasi</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Pemahaman Nutrisi</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Pemahaman Penyakit</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Pemahanman Pengobatan</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Pemahamna Perawatan</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Keyakinan & Nilai</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Keterbatasan Fisik</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Hambatan Emosional</td>").append(
                                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>Motivasi</td>").append(
                            ...
                            while (rs.next()) {
                                htmlContent.append(
                                        ...
                                        "<td valign='top'>").append(rs.getString("kemampuan_baca_tulis")).append("</td>").append(
                                        "<td valign='top'>").append(rs.getString("butuh_penerjemah")).append("</td>").append(
                                        "<td valign='top'>").append(rs.getString("keterangan_butuh_penerjemah")).append("</td>").append(
                                        "<td valign='top'>").append(rs.getString("terdapat_hambatan_belajar")).append("</td>").append(
                                        "<td valign='top'>").append(rs.getString("hambatan_belajar")).append("</td>").append(
                                        "<td valign='top'>").append(rs.getString("keterangan_hambatan_belajar")).append("</td>").append(
                                        "<td valign='top'>").append(rs.getString("hambatan_cara_bicara")).append("</td>").append(
                                        "<td valign='top'>").append(rs.getString("hambatan_bahasa_isyarat")).append("</td>").append(
                                        "<td valign='top'>").append(rs.getString("cara_belajar_disukai")).append("</td>").append(
...
//        Valid.pindah(evt, PemahamanPengobatan, SG1);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "penilaian_awal_keperawatan_ranap.penilaian_jatuhsydney_totalnilai,penilaian_awal_keperawatan_ranap.skrining_gizi1,penilaian_awal_keperawatan_ranap.nilai_gizi1,penilaian_awal_keperawatan_ranap.skrining_gizi2,"
                    + "penilaian_awal_keperawatan_ranap.nilai_gizi2,penilaian_awal_keperawatan_ranap.nilai_total_gizi,penilaian_awal_keperawatan_ranap.skrining_gizi_diagnosa_khusus,penilaian_awal_keperawatan_ranap.skrining_gizi_ket_diagnosa_khusus,"
                    + "penilaian_awal_keperawatan_ranap.skrining_gizi_diketahui_dietisen,penilaian_awal_keperawatan_ranap.skrining_gizi_jam_diketahui_dietisen,penilaian_awal_keperawatan_ranap.informasi_perencanaan_pulang,penilaian_awal_keperawatan_ranap.lama_ratarata,penilaian_awal_keperawatan_ranap.tanggal_pulang,"
                    + "penilaian_awal_keperawatan_ranap.kondisi_saat_pulang,penilaian_awal_keperawatan_ranap.perawatan_lanjutan,penilaian_awal_keperawatan_ranap.cara_transportasi,penilaian_awal_keperawatan_ranap.transportasi_digunakan,penilaian_awal_keperawatan_ranap.rencana,penilaian_awal_keperawatan_ranap.nip1,"
                    + "penilaian_awal_keperawatan_ranap.nip2,penilaian_awal_keperawatan_ranap.kd_dokter,pasien.tgl_lahir,pasien.jk,pengkaji1.nama as pengkaji1,pengkaji2.nama as pengkaji2,dokter.nm_dokter,"
                    + "reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.agama,pasien.pekerjaan,pasien.pnd,penjab.png_jawab,bahasa_pasien.nama_bahasa "
                    + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join penilaian_awal_keperawatan_ranap on reg_periksa.no_rawat=penilaian_awal_keperawatan_ranap.no_rawat "
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("pemahaman_nutrisi"), rs.getString("pemahaman_penyakit"), rs.getString("pemahaman_pengobatan"), rs.getString("pemahaman_perawatan"), rs.getString("keyakinan_nilai"), rs.getString("keterbatasan_fisik"), rs.getString("hambatan_emosional"), rs.getString("motivasi"), rs.getString("penilaian_nyeri"), rs.getString("penilaian_nyeri_penyebab") + ", " + rs.getString("penilaian_nyeri_ket_penyebab"),
                        ...
                        rs.getString("informasi_perencanaan_pulang"), rs.getString("lama_ratarata"), rs.getString("tanggal_pulang"), rs.getString("kondisi_saat_pulang"), rs.getString("perawatan_lanjutan"), rs.getString("cara_transportasi"),
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            KemampuanBacaTulis.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 120).toString());
            ButuhPenerjemah.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 121).toString());
            KeteranganButuhPenerjemah.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 122).toString());
            TerdapatHambatanBelajar.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 123).toString());
            HambatanBelajar.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 124).toString());
            KeteranganHambatanBelajar.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 125).toString());
            HambatanCaraBicara.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 126).toString());
            HambatanBahasaIsyarat.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 127).toString());
            CaraBelajarDisukai.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 128).toString());
            KesediaanMenerimaInformasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 129).toString());
            KeteranganKesediaanMenerimaInformasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 130).toString());
            PemahamanNutrisi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 131).toString());
            PemahamanPenyakit.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 132).toString());
            PemahamanPengobatan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 133).toString());
            PemahamanPerawatan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 134).toString());
            KeyakinanNilai.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 135).toString());
            KeterbatasanFisik.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 136).toString());
            HambatanEmosional.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 137).toString());
            Motivasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 138).toString());
            Nyeri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 139).toString());
            if (tbObat.getValueAt(tbObat.getSelectedRow(), 140).toString().contains("Proses Penyakit")) {
                Provokes.setSelectedItem("Proses Penyakit");
            } else if (tbObat.getValueAt(tbObat.getSelectedRow(), 140).toString().contains("Benturan")) {
                Provokes.setSelectedItem("Benturan");
            } else {
                Provokes.setSelectedItem("Lain-lain");
            }
            KetProvokes.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 140).toString().replaceAll(Provokes.getSelectedItem().toString() + ", ", ""));
            if (tbObat.getValueAt(tbObat.getSelectedRow(), 141).toString().contains("Seperti Tertusuk")) {
                Quality.setSelectedItem("Seperti Tertusuk");
            } else if (tbObat.getValueAt(tbObat.getSelectedRow(), 141).toString().contains("Berdenyut")) {
                Quality.setSelectedItem("Berdenyut");
            } else if (tbObat.getValueAt(tbObat.getSelectedRow(), 141).toString().contains("Teriris")) {
                Quality.setSelectedItem("Teriris");
            } else if (tbObat.getValueAt(tbObat.getSelectedRow(), 141).toString().contains("Tertindih")) {
                Quality.setSelectedItem("Tertindih");
            } else if (tbObat.getValueAt(tbObat.getSelectedRow(), 141).toString().contains("Tertiban")) {
                Quality.setSelectedItem("Tertiban");
            } else {
                Quality.setSelectedItem("Lain-lain");
            }
            KetQuality.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 141).toString().replaceAll(Quality.getSelectedItem().toString() + ", ", ""));
            Lokasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 142).toString());
            Menyebar.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 143).toString());
            SkalaNyeri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 144).toString());
            Durasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 145).toString());
            if (tbObat.getValueAt(tbObat.getSelectedRow(), 146).toString().contains("Istirahat")) {
                NyeriHilang.setSelectedItem("Istirahat");
            } else if (tbObat.getValueAt(tbObat.getSelectedRow(), 146).toString().contains("Medengar Musik")) {
                NyeriHilang.setSelectedItem("Medengar Musik");
            } else {
                NyeriHilang.setSelectedItem("Minum Obat");
            }
            KetNyeri.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 146).toString().replaceAll(NyeriHilang.getSelectedItem().toString() + ", ", ""));
            if (tbObat.getValueAt(tbObat.getSelectedRow(), 147).toString().contains("Ya")) {
                PadaDokter.setSelectedItem("Ya");
            } else {
                PadaDokter.setSelectedItem("Tidak");
            }
            KetPadaDokter.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 147).toString().replaceAll(PadaDokter.getSelectedItem().toString() + ", ", ""));
            SkalaResiko1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 148).toString());
            NilaiResiko1.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 149).toString());
            SkalaResiko2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 150).toString());
            NilaiResiko2.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 151).toString());
            SkalaResiko3.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 152).toString());
            NilaiResiko3.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 153).toString());
            SkalaResiko4.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 154).toString());
            NilaiResiko4.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 155).toString());
            SkalaResiko5.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 156).toString());
            NilaiResiko5.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 157).toString());
            SkalaResiko6.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 158).toString());
            NilaiResiko6.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 159).toString());
            NilaiResikoTotal.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 160).toString());
            isTotalResikoJatuh();
            SkalaSydney1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 161).toString());
            NilaiSydney1.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 162).toString());
            SkalaSydney2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 163).toString());
            NilaiSydney2.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 164).toString());
            SkalaSydney3.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 165).toString());
            NilaiSydney3.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 166).toString());
            SkalaSydney4.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 167).toString());
            NilaiSydney4.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 168).toString());
            SkalaSydney5.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 169).toString());
            NilaiSydney5.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 170).toString());
            SkalaSydney6.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 171).toString());
            NilaiSydney6.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 172).toString());
            SkalaSydney7.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 173).toString());
            NilaiSydney7.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 174).toString());
            SkalaSydney8.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 175).toString());
            NilaiSydney8.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 176).toString());
            SkalaSydney9.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 177).toString());
            NilaiSydney9.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 178).toString());
            SkalaSydney10.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 179).toString());
            NilaiSydney10.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 180).toString());
            SkalaSydney11.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 181).toString());
            NilaiSydney11.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 182).toString());
            NilaiSydneyTotal.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 183).toString());
            isTotalResikoSydney();
            ...
            Rencana.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 200).toString());
    ...
    private void getMasalah() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            DetailRencana.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 200).toString());
            try {
        ...
        if (tbObat.getSelectedRow() != -1) {
            ...
            try {
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "inner join penilaian_awal_keperawatan_ranap_kebutuhan_edukasi on penilaian_awal_keperawatan_ranap_kebutuhan_edukasi.kd_kebutuhan_edukasi=master_kebutuhan_edukasi_komunikasi.kd_kebutuhan_edukasi "
                        + "where penilaian_awal_keperawatan_ranap_kebutuhan_edukasi.no_rawat=? order by penilaian_awal_keperawatan_ranap_kebutuhan_edukasi.kd_kebutuhan_edukasi");
                try {
                    ps.setString(1, tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString());
                    rs = ps.executeQuery();
                    while (rs.next()) {
            ...
            try {
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "inner join penilaian_awal_keperawatan_ranap_rencana_edukasi on penilaian_awal_keperawatan_ranap_rencana_edukasi.kd_rencana_edukasi=master_rencana_edukasi_komunikasi.kd_rencana_edukasi "
                        + "where penilaian_awal_keperawatan_ranap_rencana_edukasi.no_rawat=? order by penilaian_awal_keperawatan_ranap_rencana_edukasi.kd_rencana_edukasi");
                try {
                    ps.setString(1, tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString());
                    rs = ps.executeQuery();
                    while (rs.next()) {
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_awal_keperawatan_ranap", "no_rawat=?", "no_rawat=?,tanggal=?,informasi=?,ket_informasi=?,tiba_diruang_rawat=?,kasus_trauma=?,cara_masuk=?,rps=?,rpd=?,rpk=?,rpo=?,riwayat_pembedahan=?,riwayat_dirawat_dirs=?,alat_bantu_dipakai=?,riwayat_kehamilan=?,riwayat_kehamilan_perkiraan=?,riwayat_tranfusi=?,riwayat_alergi=?,riwayat_merokok=?,riwayat_merokok_jumlah=?,riwayat_alkohol=?,riwayat_alkohol_jumlah=?,riwayat_narkoba=?,riwayat_olahraga=?,pemeriksaan_mental=?,pemeriksaan_keadaan_umum=?,pemeriksaan_gcs=?,pemeriksaan_td=?,pemeriksaan_nadi=?,pemeriksaan_rr=?,pemeriksaan_suhu=?,pemeriksaan_spo2=?,pemeriksaan_bb=?,pemeriksaan_tb=?,pemeriksaan_susunan_kepala=?,pemeriksaan_susunan_kepala_keterangan=?,pemeriksaan_susunan_wajah=?,pemeriksaan_susunan_wajah_keterangan=?,pemeriksaan_susunan_leher=?,pemeriksaan_susunan_kejang=?,pemeriksaan_susunan_kejang_keterangan=?,pemeriksaan_susunan_sensorik=?,pemeriksaan_kardiovaskuler_denyut_nadi=?,pemeriksaan_kardiovaskuler_sirkulasi=?,pemeriksaan_kardiovaskuler_sirkulasi_keterangan=?,pemeriksaan_kardiovaskuler_pulsasi=?,pemeriksaan_respirasi_pola_nafas=?,pemeriksaan_respirasi_retraksi=?,pemeriksaan_respirasi_suara_nafas=?,pemeriksaan_respirasi_volume_pernafasan=?,pemeriksaan_respirasi_jenis_pernafasan=?,pemeriksaan_respirasi_jenis_pernafasan_keterangan=?,pemeriksaan_respirasi_irama_nafas=?,pemeriksaan_respirasi_batuk=?,pemeriksaan_gastrointestinal_mulut=?,pemeriksaan_gastrointestinal_mulut_keterangan=?,pemeriksaan_gastrointestinal_gigi=?,pemeriksaan_gastrointestinal_gigi_keterangan=?,pemeriksaan_gastrointestinal_lidah=?,pemeriksaan_gastrointestinal_lidah_keterangan=?,pemeriksaan_gastrointestinal_tenggorokan=?,pemeriksaan_gastrointestinal_tenggorokan_keterangan=?,pemeriksaan_gastrointestinal_abdomen=?,pemeriksaan_gastrointestinal_abdomen_keterangan=?,pemeriksaan_gastrointestinal_peistatik_usus=?,pemeriksaan_gastrointestinal_anus=?,pemeriksaan_neurologi_pengelihatan=?,pemeriksaan_neurologi_pengelihatan_keterangan=?,pemeriksaan_neurologi_alat_bantu_penglihatan=?,pemeriksaan_neurologi_pendengaran=?,pemeriksaan_neurologi_bicara=?,pemeriksaan_neurologi_bicara_keterangan=?,pemeriksaan_neurologi_sensorik=?,pemeriksaan_neurologi_motorik=?,pemeriksaan_neurologi_kekuatan_otot=?,pemeriksaan_integument_warnakulit=?,pemeriksaan_integument_turgor=?,pemeriksaan_integument_kulit=?,pemeriksaan_integument_dekubitas=?,pemeriksaan_muskuloskletal_pergerakan_sendi=?,pemeriksaan_muskuloskletal_kekauatan_otot=?,pemeriksaan_muskuloskletal_nyeri_sendi=?,pemeriksaan_muskuloskletal_nyeri_sendi_keterangan=?,pemeriksaan_muskuloskletal_oedema=?,pemeriksaan_muskuloskletal_oedema_keterangan=?,pemeriksaan_muskuloskletal_fraktur=?,pemeriksaan_muskuloskletal_fraktur_keterangan=?,pemeriksaan_eliminasi_bab_frekuensi_jumlah=?,pemeriksaan_eliminasi_bab_frekuensi_durasi=?,pemeriksaan_eliminasi_bab_konsistensi=?,pemeriksaan_eliminasi_bab_warna=?,pemeriksaan_eliminasi_bak_frekuensi_jumlah=?,pemeriksaan_eliminasi_bak_frekuensi_durasi=?,pemeriksaan_eliminasi_bak_warna=?,pemeriksaan_eliminasi_bak_lainlain=?,pola_aktifitas_makanminum=?,pola_aktifitas_mandi=?,pola_aktifitas_eliminasi=?,pola_aktifitas_berpakaian=?,pola_aktifitas_berpindah=?,pola_nutrisi_frekuesi_makan=?,pola_nutrisi_jenis_makanan=?,pola_nutrisi_porsi_makan=?,pola_tidur_lama_tidur=?,pola_tidur_gangguan=?,pengkajian_fungsi_kemampuan_sehari=?,pengkajian_fungsi_aktifitas=?,pengkajian_fungsi_berjalan=?,pengkajian_fungsi_berjalan_keterangan=?,pengkajian_fungsi_ambulasi=?,pengkajian_fungsi_ekstrimitas_atas=?,pengkajian_fungsi_ekstrimitas_atas_keterangan=?,pengkajian_fungsi_ekstrimitas_bawah=?,pengkajian_fungsi_ekstrimitas_bawah_keterangan=?,pengkajian_fungsi_menggenggam=?,pengkajian_fungsi_menggenggam_keterangan=?,pengkajian_fungsi_koordinasi=?,pengkajian_fungsi_koordinasi_keterangan=?,pengkajian_fungsi_kesimpulan=?,riwayat_psiko_kondisi_psiko=?,riwayat_psiko_gangguan_jiwa=?,riwayat_psiko_perilaku=?,riwayat_psiko_perilaku_keterangan=?,riwayat_psiko_hubungan_keluarga=?,riwayat_psiko_tinggal=?,riwayat_psiko_tinggal_keterangan=?,riwayat_psiko_nilai_kepercayaan=?,riwayat_psiko_nilai_kepercayaan_keterangan=?,riwayat_psiko_pendidikan_pj=?,riwayat_psiko_edukasi_diberikan=?,riwayat_psiko_edukasi_diberikan_keterangan=?,kemampuan_baca_tulis=?,butuh_penerjemah=?,keterangan_butuh_penerjemah=?,terdapat_hambatan_belajar=?,hambatan_belajar=?,keterangan_hambatan_belajar=?,hambatan_cara_bicara=?,hambatan_bahasa_isyarat=?,cara_belajar_disukai=?,kesediaan_menerima_informasi=?,ket_kesediaan_menerima_informasi=?,pemahaman_nutrisi=?,pemahaman_penyakit=?,pemahaman_pengobatan=?,pemahaman_perawatan=?,keyakinan_nilai=?,keterbatasan_fisik=?,hambatan_emosional=?,Motivasi=?,penilaian_nyeri=?,penilaian_nyeri_penyebab=?,penilaian_nyeri_ket_penyebab=?,penilaian_nyeri_kualitas=?,penilaian_nyeri_ket_kualitas=?,penilaian_nyeri_lokasi=?,penilaian_nyeri_menyebar=?,penilaian_nyeri_skala=?,penilaian_nyeri_waktu=?,penilaian_nyeri_hilang=?,penilaian_nyeri_ket_hilang=?,penilaian_nyeri_diberitahukan_dokter=?,penilaian_nyeri_jam_diberitahukan_dokter=?,penilaian_jatuhmorse_skala1=?,penilaian_jatuhmorse_nilai1=?,penilaian_jatuhmorse_skala2=?,penilaian_jatuhmorse_nilai2=?,penilaian_jatuhmorse_skala3=?,penilaian_jatuhmorse_nilai3=?,penilaian_jatuhmorse_skala4=?,penilaian_jatuhmorse_nilai4=?,penilaian_jatuhmorse_skala5=?,penilaian_jatuhmorse_nilai5=?,penilaian_jatuhmorse_skala6=?,penilaian_jatuhmorse_nilai6=?,penilaian_jatuhmorse_totalnilai=?,penilaian_jatuhsydney_skala1=?,penilaian_jatuhsydney_nilai1=?,penilaian_jatuhsydney_skala2=?,penilaian_jatuhsydney_nilai2=?,penilaian_jatuhsydney_skala3=?,penilaian_jatuhsydney_nilai3=?,penilaian_jatuhsydney_skala4=?,penilaian_jatuhsydney_nilai4=?,penilaian_jatuhsydney_skala5=?,penilaian_jatuhsydney_nilai5=?,penilaian_jatuhsydney_skala6=?,penilaian_jatuhsydney_nilai6=?,penilaian_jatuhsydney_skala7=?,penilaian_jatuhsydney_nilai7=?,penilaian_jatuhsydney_skala8=?,penilaian_jatuhsydney_nilai8=?,penilaian_jatuhsydney_skala9=?,penilaian_jatuhsydney_nilai9=?,penilaian_jatuhsydney_skala10=?,penilaian_jatuhsydney_nilai10=?,penilaian_jatuhsydney_skala11=?,penilaian_jatuhsydney_nilai11=?,penilaian_jatuhsydney_totalnilai=?,skrining_gizi1=?,nilai_gizi1=?,skrining_gizi2=?,nilai_gizi2=?,nilai_total_gizi=?,skrining_gizi_diagnosa_khusus=?,skrining_gizi_ket_diagnosa_khusus=?,skrining_gizi_diketahui_dietisen=?,skrining_gizi_jam_diketahui_dietisen=?,informasi_perencanaan_pulang=?,lama_ratarata=?,tanggal_pulang=?,kondisi_saat_pulang=?,perawatan_lanjutan=?,cara_transportasi=?,transportasi_digunakan=?,rencana=?,nip1=?,nip2=?,kd_dokter=?", 220, new String[]{
            ...
            NilaiKepercayaan.getSelectedItem().toString(), KeteranganNilaiKepercayaan.getText(), PendidikanPJ.getSelectedItem().toString(), EdukasiPsikolgis.getSelectedItem().toString(), KeteranganEdukasiPsikologis.getText(), KemampuanBacaTulis.getSelectedItem().toString(), ButuhPenerjemah.getSelectedItem().toString(),
            ...
            HambatanEmosional.getSelectedItem().toString(), Motivasi.getSelectedItem().toString(), Nyeri.getSelectedItem().toString(), Provokes.getSelectedItem().toString(), KetProvokes.getText(),
            ...
            KeteranganDiagnosaKhususGizi.getText(), DiketahuiDietisen.getSelectedItem().toString(), KeteranganDiketahuiDietisen.getText(), InformasiPerencanaanPulang.getSelectedItem().toString(),
            LamaRatarata.getText(), Valid.SetTgl(TanggalPulang.getSelectedItem() + ""),
            KondisiPulang.getText(), PerawatanLanjutan.getText(), CaraTransportasiPulang.getSelectedItem().toString(), TransportasiYangDigunakan.getSelectedItem().toString(), Rencana.getText(), KdPetugas.getText(), KdPetugas2.getText(), KdDokter.getText(), tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
        }) == true) {
            ...
            tbObat.setValueAt(KemampuanBacaTulis.getSelectedItem().toString(), tbObat.getSelectedRow(), 120);
            tbObat.setValueAt(ButuhPenerjemah.getSelectedItem().toString(), tbObat.getSelectedRow(), 121);
            tbObat.setValueAt(KeteranganButuhPenerjemah.getText(), tbObat.getSelectedRow(), 122);
            tbObat.setValueAt(TerdapatHambatanBelajar.getSelectedItem().toString(), tbObat.getSelectedRow(), 123);
            tbObat.setValueAt(HambatanBelajar.getSelectedItem().toString(), tbObat.getSelectedRow(), 124);
            tbObat.setValueAt(KeteranganHambatanBelajar.getText(), tbObat.getSelectedRow(), 125);
            tbObat.setValueAt(HambatanCaraBicara.getSelectedItem().toString(), tbObat.getSelectedRow(), 126);
            tbObat.setValueAt(HambatanBahasaIsyarat.getSelectedItem().toString(), tbObat.getSelectedRow(), 127);
            tbObat.setValueAt(CaraBelajarDisukai.getSelectedItem().toString(), tbObat.getSelectedRow(), 128);
            tbObat.setValueAt(KesediaanMenerimaInformasi.getSelectedItem().toString(), tbObat.getSelectedRow(), 129);
            tbObat.setValueAt(KeteranganKesediaanMenerimaInformasi.getText(), tbObat.getSelectedRow(), 130);
            tbObat.setValueAt(PemahamanNutrisi.getSelectedItem().toString(), tbObat.getSelectedRow(), 131);
            tbObat.setValueAt(PemahamanPenyakit.getSelectedItem().toString(), tbObat.getSelectedRow(), 132);
            tbObat.setValueAt(PemahamanPengobatan.getSelectedItem().toString(), tbObat.getSelectedRow(), 133);
            tbObat.setValueAt(PemahamanPerawatan.getSelectedItem().toString(), tbObat.getSelectedRow(), 134);
            tbObat.setValueAt(KeyakinanNilai.getSelectedItem().toString(), tbObat.getSelectedRow(), 135);
            tbObat.setValueAt(KeterbatasanFisik.getSelectedItem().toString(), tbObat.getSelectedRow(), 136);
            tbObat.setValueAt(HambatanEmosional.getSelectedItem().toString(), tbObat.getSelectedRow(), 137);
            tbObat.setValueAt(Motivasi.getSelectedItem().toString(), tbObat.getSelectedRow(), 138);
            tbObat.setValueAt(Nyeri.getSelectedItem().toString(), tbObat.getSelectedRow(), 139);
            tbObat.setValueAt(Provokes.getSelectedItem() + ", " + KetProvokes.getText(), tbObat.getSelectedRow(), 140);
            tbObat.setValueAt(Quality.getSelectedItem() + ", " + KetQuality.getText(), tbObat.getSelectedRow(), 141);
            tbObat.setValueAt(Lokasi.getText(), tbObat.getSelectedRow(), 142);
            tbObat.setValueAt(Menyebar.getSelectedItem().toString(), tbObat.getSelectedRow(), 143);
            tbObat.setValueAt(SkalaNyeri.getSelectedItem().toString(), tbObat.getSelectedRow(), 144);
            tbObat.setValueAt(Durasi.getText(), tbObat.getSelectedRow(), 145);
            tbObat.setValueAt(NyeriHilang.getSelectedItem() + ", " + KetNyeri.getText(), tbObat.getSelectedRow(), 146);
            tbObat.setValueAt(PadaDokter.getSelectedItem() + ", " + KetPadaDokter.getText(), tbObat.getSelectedRow(), 147);
            tbObat.setValueAt(SkalaResiko1.getSelectedItem().toString(), tbObat.getSelectedRow(), 148);
            tbObat.setValueAt(NilaiResiko1.getText(), tbObat.getSelectedRow(), 149);
            tbObat.setValueAt(SkalaResiko2.getSelectedItem().toString(), tbObat.getSelectedRow(), 150);
            tbObat.setValueAt(NilaiResiko2.getText(), tbObat.getSelectedRow(), 151);
            tbObat.setValueAt(SkalaResiko3.getSelectedItem().toString(), tbObat.getSelectedRow(), 152);
            tbObat.setValueAt(NilaiResiko3.getText(), tbObat.getSelectedRow(), 153);
            tbObat.setValueAt(SkalaResiko4.getSelectedItem().toString(), tbObat.getSelectedRow(), 154);
            tbObat.setValueAt(NilaiResiko4.getText(), tbObat.getSelectedRow(), 155);
            tbObat.setValueAt(SkalaResiko5.getSelectedItem().toString(), tbObat.getSelectedRow(), 156);
            tbObat.setValueAt(NilaiResiko5.getText(), tbObat.getSelectedRow(), 157);
            tbObat.setValueAt(SkalaResiko6.getSelectedItem().toString(), tbObat.getSelectedRow(), 158);
            tbObat.setValueAt(NilaiResiko6.getText(), tbObat.getSelectedRow(), 159);
            tbObat.setValueAt(NilaiResikoTotal.getText(), tbObat.getSelectedRow(), 160);
            tbObat.setValueAt(SkalaSydney1.getSelectedItem().toString(), tbObat.getSelectedRow(), 161);
            tbObat.setValueAt(NilaiSydney1.getText(), tbObat.getSelectedRow(), 162);
            tbObat.setValueAt(SkalaSydney2.getSelectedItem().toString(), tbObat.getSelectedRow(), 163);
            tbObat.setValueAt(NilaiSydney2.getText(), tbObat.getSelectedRow(), 164);
            tbObat.setValueAt(SkalaSydney3.getSelectedItem().toString(), tbObat.getSelectedRow(), 165);
            tbObat.setValueAt(NilaiSydney3.getText(), tbObat.getSelectedRow(), 166);
            tbObat.setValueAt(SkalaSydney4.getSelectedItem().toString(), tbObat.getSelectedRow(), 167);
            tbObat.setValueAt(NilaiSydney4.getText(), tbObat.getSelectedRow(), 168);
            tbObat.setValueAt(SkalaSydney5.getSelectedItem().toString(), tbObat.getSelectedRow(), 169);
            tbObat.setValueAt(NilaiSydney5.getText(), tbObat.getSelectedRow(), 170);
            tbObat.setValueAt(SkalaSydney6.getSelectedItem().toString(), tbObat.getSelectedRow(), 171);
            tbObat.setValueAt(NilaiSydney6.getText(), tbObat.getSelectedRow(), 172);
            tbObat.setValueAt(SkalaSydney7.getSelectedItem().toString(), tbObat.getSelectedRow(), 173);
            tbObat.setValueAt(NilaiSydney7.getText(), tbObat.getSelectedRow(), 174);
            tbObat.setValueAt(SkalaSydney8.getSelectedItem().toString(), tbObat.getSelectedRow(), 175);
            tbObat.setValueAt(NilaiSydney8.getText(), tbObat.getSelectedRow(), 176);
            tbObat.setValueAt(SkalaSydney9.getSelectedItem().toString(), tbObat.getSelectedRow(), 177);
            tbObat.setValueAt(NilaiSydney9.getText(), tbObat.getSelectedRow(), 178);
            tbObat.setValueAt(SkalaSydney10.getSelectedItem().toString(), tbObat.getSelectedRow(), 179);
            tbObat.setValueAt(NilaiSydney10.getText(), tbObat.getSelectedRow(), 180);
            tbObat.setValueAt(SkalaSydney11.getSelectedItem().toString(), tbObat.getSelectedRow(), 181);
            tbObat.setValueAt(NilaiSydney11.getText(), tbObat.getSelectedRow(), 182);
            tbObat.setValueAt(NilaiSydneyTotal.getText(), tbObat.getSelectedRow(), 183);
            ...
            tbObat.setValueAt(Rencana.getText(), tbObat.getSelectedRow(), 200);
            ...
            Sequel.meghapus("penilaian_awal_keperawatan_ranap_kebutuhan_edukasi", "no_rawat", tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString());
            Sequel.meghapus("penilaian_awal_keperawatan_ranap_rencana_edukasi", "no_rawat", tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString());
            ...
            for (i = 0; i < tbKebutuhanEdukasi.getRowCount(); i++) {
                if (tbKebutuhanEdukasi.getValueAt(i, 0).toString().equals("true")) {
                    if (Sequel.menyimpantf2("penilaian_awal_keperawatan_ranap_kebutuhan_edukasi", "?,?", 2, new String[]{TNoRw.getText(), tbKebutuhanEdukasi.getValueAt(i, 1).toString()}) == true) {
            ...
            for (i = 0; i < tbRencanaEdukasi.getRowCount(); i++) {
                if (tbRencanaEdukasi.getValueAt(i, 0).toString().equals("true")) {
                    if (Sequel.menyimpantf2("penilaian_awal_keperawatan_ranap_rencana_edukasi", "?,?", 2, new String[]{TNoRw.getText(), tbRencanaEdukasi.getValueAt(i, 1).toString()}) == true) {
    ...
    private void simpan() {
        if (Sequel.menyimpantf("penilaian_awal_keperawatan_ranap", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 219, new String[]{
            TNoRw.getText(), Valid.SetTgl(TglAsuhan.getSelectedItem() + "") + " " + TglAsuhan.getSelectedItem().toString().substring(11, 19), Anamnesis.getSelectedItem().toString(), KetAnamnesis.getText(), TibadiRuang.getSelectedItem().toString(), MacamKasus.getSelectedItem().toString(),
            CaraMasuk.getSelectedItem().toString(), RPS.getText(), RPD.getText(), RPK.getText(), RPO.getText(), RPembedahan.getText(), RDirawatRS.getText(), AlatBantuDipakai.getSelectedItem().toString(), SedangMenyusui.getSelectedItem().toString(), KetSedangMenyusui.getText(), RTranfusi.getText(),
            Alergi.getText(), KebiasaanMerokok.getSelectedItem().toString(), KebiasaanJumlahRokok.getText(), KebiasaanAlkohol.getSelectedItem().toString(), KebiasaanJumlahAlkohol.getText(), KebiasaanNarkoba.getSelectedItem().toString(), OlahRaga.getSelectedItem().toString(), KesadaranMental.getText(),
            KeadaanMentalUmum.getSelectedItem().toString(), GCS.getText(), TD.getText(), Nadi.getText(), RR.getText(), Suhu.getText(), SpO2.getText(), BB.getText(), TB.getText(), SistemSarafKepala.getSelectedItem().toString(), KetSistemSarafKepala.getText(), SistemSarafWajah.getSelectedItem().toString(),
            ...
            KeteranganDiagnosaKhususGizi.getText(), DiketahuiDietisen.getSelectedItem().toString(), KeteranganDiketahuiDietisen.getText(), InformasiPerencanaanPulang.getSelectedItem().toString(),
            LamaRatarata.getText(), Valid.SetTgl(TanggalPulang.getSelectedItem() + ""),
            KondisiPulang.getText(), PerawatanLanjutan.getText(), CaraTransportasiPulang.getSelectedItem().toString(), TransportasiYangDigunakan.getSelectedItem().toString(), Rencana.getText(), KdPetugas.getText(), KdPetugas2.getText(), KdDokter.getText()
        }) == true) {
            tabMode.addRow(new Object[]{
                ...
                EdukasiPsikolgis.getSelectedItem() + ", " + KeteranganEdukasiPsikologis.getText(), KemampuanBacaTulis.getSelectedItem().toString(), ButuhPenerjemah.getSelectedItem().toString(),
                KeteranganButuhPenerjemah.getText(), TerdapatHambatanBelajar.getSelectedItem().toString(), HambatanBelajar.getSelectedItem().toString(), KeteranganHambatanBelajar.getText(),
                HambatanCaraBicara.getSelectedItem().toString(), HambatanBahasaIsyarat.getSelectedItem().toString(), CaraBelajarDisukai.getSelectedItem().toString(), KesediaanMenerimaInformasi.getSelectedItem().toString(), KeteranganKesediaanMenerimaInformasi.getText(),
                PemahamanNutrisi.getSelectedItem().toString(), PemahamanPenyakit.getSelectedItem().toString(), PemahamanPengobatan.getSelectedItem().toString(), PemahamanPerawatan.getSelectedItem().toString(), KeyakinanNilai.getSelectedItem().toString(), KeterbatasanFisik.getSelectedItem().toString(),
                HambatanEmosional.getSelectedItem().toString(), Motivasi.getSelectedItem().toString(), Nyeri.getSelectedItem().toString(), Provokes.getSelectedItem() + ", " + KetProvokes.getText(), Quality.getSelectedItem() + ", " + KetQuality.getText(), Lokasi.getText(), Menyebar.getSelectedItem().toString(), SkalaNyeri.getSelectedItem().toString(),
                ...
                SkalaGizi2.getSelectedItem().toString(), NilaiGizi2.getText(), NilaiGiziTotal.getText(), DiagnosaKhususGizi.getSelectedItem().toString(), KeteranganDiagnosaKhususGizi.getText(), DiketahuiDietisen.getSelectedItem().toString(), KeteranganDiketahuiDietisen.getText(), InformasiPerencanaanPulang.getSelectedItem().toString(),
                LamaRatarata.getText(), Valid.SetTgl(TanggalPulang.getSelectedItem() + ""),
                KondisiPulang.getText(), PerawatanLanjutan.getText(), CaraTransportasiPulang.getSelectedItem().toString(), TransportasiYangDigunakan.getSelectedItem().toString(), Rencana.getText()
            });
            for (i = 0; i < tbMasalahKeperawatan.getRowCount(); i++) {
                if (tbMasalahKeperawatan.getValueAt(i, 0).toString().equals("true")) {
                    if (Sequel.menyimpantf2("penilaian_awal_keperawatan_ranap_masalah", "?,?", 2, new String[]{TNoRw.getText(), tbMasalahKeperawatan.getValueAt(i, 1).toString()}) == true) {
