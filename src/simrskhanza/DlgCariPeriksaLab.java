                ...
                try {
                    ...
                    if(rs.next()){
                        ...
                        Valid.panggilUrl("billing/LaporanBiayaLab.php?norm="+rs.getString("no_rkm_medis")+"&pasien="+rs.getString("nm_pasien").replaceAll(" ","_")
                                ...
                                //CUSTOM RSIL
                                +"&petugas="+Sequel.cariIsi("select pegawai.nama from pegawai where pegawai.nik=?",rs.getString("dokter_perujuk")).replaceAll(" ","_")
                                +"&kasir="+Sequel.cariIsi("select pegawai.nama from pegawai where pegawai.nik=?",akses.getkode())
