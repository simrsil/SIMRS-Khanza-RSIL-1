...
$_sql2  = "select persetujuan_penolakan_tindakan.tanggal,persetujuan_penolakan_tindakan.diagnosa,persetujuan_penolakan_tindakan.tindakan,persetujuan_penolakan_tindakan.indikasi_tindakan,
               ...
               persetujuan_penolakan_tindakan.hubungan_penerima_informasi,persetujuan_penolakan_tindakan.saksi_keluarga,persetujuan_penolakan_tindakan.kondisi  
...
<body>
    <div class="container">
        <h5 class="text-dark">
            <center><button class="btn btn-secondary" onclick="window.location.reload();">Refresh</button><br /><br />Pernyataan Persetujuan/Penolakan Tindakan No. <?= $nopernyataan; ?></center>
        </h5>
        <h7 class="text-dark">
        ...
        <form method="POST" action="pages/storeImage.php" onsubmit="return validasiIsi();" enctype=multipart/form-data>
            ...
            <br />
            <h7 class="text-dark">
                Dengan ini menyatakan <select name="pilihansetuju" class="text-dark">
                    <option value='Persetujuan'>Persetujuan</option>
                    <option value='Penolakan'>Penolakan</option>
                </select> untuk dapat dilakukan tindakan kedokteran berupa :
            </h7>
            <table class="default" width="100%" border="0" align="center" cellpadding="3px" cellspacing="0px">
                <tr class="text-dark">
                    <td width="30%">Kondisi Pasien</td>
                    <td width="60%">: <?= $kondisi; ?></td>
                    <td width="10%"><input type="checkbox" name="kondisi_konfirmasi"></td>
                </tr>
                <tr class="text-dark">
                ...
                <div class="col-md-6">
                    <div id="results">
                        <h7 class="text-success">
                            <center>Gambar akan diambil jika anda sudah mengeklik ya</center>
                        </h7>
                    </div>
